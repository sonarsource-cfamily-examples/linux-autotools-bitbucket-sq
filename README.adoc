...
.. Download the https://docs.sonarqube.org/latest/analyzing-source-code/languages/c-family/#using-build-wrapper[`build wrapper`] and wrap your compilation with it
